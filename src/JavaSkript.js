...
function addToTab() { currentTabValue = currentTabValue + "    "; }
function takeFromTab() { currentTabValue = currentTabValue - "    "; }
function resetTabValue() { currentTabValue = ""; }
function addDataToFile() { fs.writeFileSync("C:/JavaSkript/out/output.sk", data); };
